...
/**
 * A {@code Callback} for stopping a {@code TimerContext} on completion.
 */
public class TimerStoppingCallback<T> implements Callback<T, T> {
     ...
     *
     * @param timer the active {@link Timer} to stop on completion of the
     *              {@link Callback}.
     */
    ...
    /**
     * Stops the registered {@link Timer} and proxies any argument through
     * verbatim.
     *
     ...
     *
     * @throws Exception if an error occurs stopping the {@link Timer}.
     */
